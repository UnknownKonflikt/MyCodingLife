        ...
        <section id="ContactSection" >
            <main className="form-signin col-12 col-sm-6 text-center w-100 m-auto">
                <form ref={form} onSubmit={sendEmail}>
                    ...
                    <h2 className="h3 mb-3 fw-normal">Please leave your details</h2>
                    ...
                    <button type="submit" className="btn btn-outline-dark btn-lg px-4 me-md-2">
                        Send Message
                    </button>
                </form>
            </main>
